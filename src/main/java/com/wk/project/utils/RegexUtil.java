...
import com.longi.msp.common.constant.CommonConstant;
...
public class RegexUtil {
    ...
    public static final String MOBILE =
        "^134[0-8]\\d{7}$|^13[^4]\\d{8}$|^14[5-9]\\d{8}$|^15[^4]\\d{8}$|^16[6]\\d{8}$|^17[0-8]\\d{8}$|^18[\\d]{9}$|^19[89]\\d{8}$";
    ...
    public static boolean isMobile(String str) {
        return isMobile(CommonConstant.DEFAULT_CROWN_CODE, str);
    }

    public static boolean isMobile(String crownCode, String phone) {
        crownCode = StringUtils.defaultIfBlank(crownCode, CommonConstant.DEFAULT_CROWN_CODE);
        int code = 0;
        long telNumber = 0;
        try {
